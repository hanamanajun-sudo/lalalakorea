...
### 4．BTS × Weverse Shopコラボビール『ビールまでARMY仕様！』

タイトルにある**BTS**のコラボも忘れてはいけません。

BTSのファンコミュニティプラットフォーム**Weverse Shop**と韓国のビールブランドがコラボし、ARMYの間で大きな話題となりました。缶のデザインにはBTSのロゴやメンバーをイメージしたデザインが採用され、「**推しと一緒に飲む一杯**」として一部限定販売されました。

韓国のコンビニ文化では、こうした**限定コラボ商品**が短期間で入れ替わるため、SNSでいち早く情報をキャッチすることが重要。韓国旅行の際はコンビニのビールコーナーも要チェックです！
...
韓国のコンビニビール文化、実は私（ジュン）も帰省するたびに変化を感じます。数年前は「テラ」「ク라스（KLASS）」あたりが定番でしたが、今ではコラボデザイン缶がずらりと並んでいて、もはやビールコーナーがアート展示のよう（笑）。

ハルも初めて韓国に来たとき、コンビニでビールを選びながら「これどのキャラクター？」「これBTSじゃないの！？」と大興奮でした。韓国のコンビニはお酒の棚ひとつとっても話題に事欠かないので、旅行中はぜひじっくり見てみてください。

**홈술（ホムスル）＝家飲み**、**혼술（ホンスル）＝ひとり飲み**という言葉が若者の間で定着したのも、こうしたコラボビールブームと無関係ではないと思います。

## まとめ

今回紹介した韓国のコラボビールは、どれもデザインのこだわりが半端なく、コレクター心をくすぐる仕上がりです。

- **セブンイレブン × 배달의 민족**：「와맥주（ワァメクチュ）」
- **セブンイレブン × 뚱랑이**：ゆったりキャラのON/OFFビール
- **CU × プルダックポックンミョン**：激辛ラーメンのお供マンゴーエール
- **BTS × Weverse Shop**：ARMY限定コラボ缶

韓国旅行の際はコンビニのビールコーナーをぜひチェックしてみてください！
